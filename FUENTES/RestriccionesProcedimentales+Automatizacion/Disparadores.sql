...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM autores;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM animes;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM personajes;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM ropa;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM proveedores;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM figuras;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM tarjetadescuento;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM ventas;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM sedes;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM ejemplares;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM compras;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM empleados;
END;
/
...
FOR EACH ROW
BEGIN 
	SELECT MAX(id)+1 INTO :NEW.id FROM contratos;
END;
/
