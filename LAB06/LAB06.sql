...
CREATE OR REPLACE PACKAGE BODY PA_JUNTA IS
    ...
    FUNCTION CO_VALIDACIONES_REGISTRADAS RETURN SYS_REFCURSOR IS CONSULTA SYS_REFCURSOR;
    BEGIN
        CONSULTA := PC_VALIDACIONES.CO_VALIDACIONES_REGISTRADAS;
	END;
...
CREATE OR REPLACE PACKAGE BODY PA_PERFIL IS
    ...
    FUNCTION CO_VALIDACIONES RETURN SYS_REFCURSOR IS CONSULTA SYS_REFCURSOR;
    BEGIN
        OPEN CONSULTA  FOR
		SELECT competencias.nombre , COUNT(validaciones)
        from competencias, validaciones;
		RETURN CONSULTA;
	END;
...
GRANT EXECUTE ON PA_JUNTA TO JUNTA;
GRANT EXECUTE ON PA_PERFIL TO PERFIL;
GRANT EXECUTE ON PC_VALIDACIONES TO PERFIL;


GRANT EXECUTE ON PA_JUNTA TO BD2152972;
REVOKE EXECUTE ON PA_JUNTA FROM BD2152972;

--XSEGURIDAD

REVOKE EXECUTE ON PA_JUNTA FROM JUNTA;
REVOKE EXECUTE ON PA_PERFIL FROM PERFIL;
